...
def create_caption(textJSON, framesize, font="Montserrat-Bold", fontsize=25, color='black', bgcolor='gray'):
...
image_path = "bg.png"  # Replace with the path to your image
background_image = ImageClip(image_path, duration=input_video_duration)
