...
def create_caption(textJSON, framesize, font="Mulish-SemiBold.ttf", fontsize=80, color='Black', bgcolor='yellow'):
...
video_path = "shorts_paper_bg.mp4"
...
final_video.write_videofile("Mulish_150_80.mp4", fps=24, codec="libx264", audio_codec="aac")