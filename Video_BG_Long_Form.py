import os
from moviepy.editor import AudioFileClip, ImageClip, CompositeVideoClip, TextClip,VideoFileClip, CompositeVideoClip, ColorClip
...
def create_caption(textJSON, framesize, font="Mulish-SemiBold.ttf", fontsize=85, color='Black', bgcolor='yellow'):
...
video_path = "Long_form_paper_bg.mp4"

background_video = VideoFileClip(video_path)
final_video = CompositeVideoClip([background_video] + all_linelevel_splits)
final_video = final_video.set_audio(input_audio)

final_video = final_video.set_duration(input_audio.duration)
final_video.write_videofile("Mulish_280_85.mp4", fps=24, codec="libx264", audio_codec="aac")