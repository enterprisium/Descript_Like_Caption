...
def create_caption(textJSON, framesize, font="Mulish-SemiBold.ttf", fontsize=50, color='white', bgcolor='blue'):
...
image_clip = ImageClip('shadow_bg.png').set_duration(input_video_duration)
image_clip = image_clip.set_position(('right', 'bottom'))
final_video = CompositeVideoClip([input_video] + [image_clip]) + all_linelevel_splits
final_video = final_video.set_audio(input_video.audio)
final_video.write_videofile("Modi_Final6.mp4", fps=24, codec="libx264", audio_codec="aac")
